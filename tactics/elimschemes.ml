...
let rect_dep =
  declare_individual_scheme_object ["Induction";"Type"]
...
enleve dep dans suff *)
let rec_dep =
  declare_individual_scheme_object ["Induction";"Set"]
...
let ind_dep =
  declare_individual_scheme_object ["Induction";"Prop"]
...
let sind_dep =
  declare_individual_scheme_object ["Induction";"SProp"]
...
let rect_nodep =
  declare_individual_scheme_object ["Minimality";"Type"]
...
let rec_nodep =
  declare_individual_scheme_object ["Minimality";"Set"]
...
let ind_nodep =
  declare_individual_scheme_object ["Minimality";"Prop"]
...
enleve nodep dans suff *)
let sind_nodep =
  declare_individual_scheme_object ["Minimality";"SProp"]
...
(* Elimination, inType *)
let case_dep =
  declare_individual_scheme_object ["Elimination";"Type"]
...
(* Case, inType*)
let case_nodep =
  declare_individual_scheme_object ["Case";"Type"]
...
(* Elimination, inProp*)
let casep_dep =
  declare_individual_scheme_object ["Elimination";"Prop"]
...
(* Case, InProp *)
let casep_nodep =
  declare_individual_scheme_object ["Case";"Prop"]
