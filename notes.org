...
supprimer scheme_type et equality_sheme_type

- [ ] trois manieres de CREER les schemas : 
...
changer dans elimscheme tous les 
...
1) rajouter sort dans clef
2) changer dans elimscheme les clefs
3) supprimer tout le code hard-codé
